...
<a href="employability?employability=Employed" class="btn btn-secondary" style="float:right; margin:10px;">Back</a>
...
?>	  </tbody>
      ...
      ?>
<div class="" style="width:100%;">
<a href="employability?employability=Unemployed" class="btn btn-secondary" style="float:right; margin:10px;">Back</a>
<button class="btn btn-primary" style="float:right; margin:10px;"  onclick="print()">Print</button>
</div>
<div class="con" id="con">
<h5>Alumni Employability Status</h5>
...
?>	  </tbody>
 ...
 <?php
  ...
  ?>
<div class="" style="width:100%;">
<a href="employability?employability=Self-Employed" class="btn btn-secondary" style="float:right; margin:10px;">Back</a>
<button class="btn btn-primary" style="float:right; margin:10px;"  onclick="print()">Print</button>
</div>
<div class="con" id="con">
