<?php 
 ...
 if(mysqli_num_rows($result) == 0) {
   ...
   if(mysqli_query($con, $query)) {
    ...
    header("location:signup?message=changesuccess");
       
   } else {

    header('location:signup?message=loginfailed');
   }
 } else {
    header('location:signup?message=loginfailed');
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="address" required>
       ...
       <div class="pt-1 mb-4" style="float:right; margin-top:50px;">
                <a href="dashboard" class="btn btn-secondary btn-lg btn-block" type="button" name="back">Back</a>
