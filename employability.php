...
<ul class="breadcrumb">
  ...
  <li><a href="employability?employability=Employed">Employability Status</a></li>
  ...
  <div class="container-fluid">
    <ul class="emp navbar-nav" style="display: inline-block;">
      <li class="active"><a href="employability?employability=Employed">EMPLOYED</a></li>
      <li><a href="employability?employability=Unemployed">UNEMPLOYED</a></li>
      <li><a href="employability?employability=Self-Employed">SELF-EMPLOYED</a></li>
    </ul>
  </div>
</nav>
<div class="d2">
	...
	$query = "SELECT * FROM programs";
		...
		while ($row=mysqli_fetch_assoc($result)) {
			...
			?>
		<a href="employed?course=<?php echo $name;?>">
		<div class="items">
			<div class="icon">
 ...
 <a href="printreport?emp=employed" class="btn btn-primary">Print Report</a>
 </div>
 </form>
 <form class="filter form-inline">
...
<ul class="breadcrumb">
  ...
  <div class="container-fluid">
    <ul class="emp navbar-nav" style="display: inline-block;">
      <li><a href="employability?employability=Employed">Employed</a></li>
      <li class="active"><a href="employability?employability=Unemployed">Unemployed</a></li>
      <li><a href="employability?employability=Self-Employed">Self-Employed</a></li>
    </ul>
  </div>
</nav>
<div class="d2">
	...
	$query = "SELECT * FROM programs";
		...
		while ($row=mysqli_fetch_assoc($result)) {
			$name = $row['ABBREVIATION'];?>
		<a href="unemployed?course=<?php echo $name;?>">
		<div class="items">
			<div class="icon">
				<span><?php echo $name; ?></span>
			</div>
 ...
 <div class="form-group">
 <a href="printreport?emp=unemployed" class="btn btn-primary">Print Report</a>
 </div>
 </form>
 <form class="filter form-inline">
<div class="form-group" style="width:100%;">
...
<ul class="breadcrumb">
  ...
  <div class="container-fluid">
    <ul class="emp navbar-nav" style="display: inline-block;">
      <li><a href="employability?employability=Employed">Employed</a></li>
      <li><a href="employability?employability=Unemployed">Unemployed</a></li>
      <li class="active"><a href="employability?employability=Self-Employed">Self-Employed</a></li>
    </ul>
  </div>
</nav>
<div class="d2">
	...
	$query = "SELECT * FROM programs";
		...
		while ($row=mysqli_fetch_assoc($result)) {
			$name = $row['ABBREVIATION'];?>
		<a href="self_employed?course=<?php echo $name;?>">
		<div class="items">
			<div class="icon">
				<span><?php echo $name; ?></span>
			</div>
 ...
 <div class="form-group">
 <a href="printreport?emp=self-employed" class="btn btn-primary">Print Report</a>
 </div>
 </form>
 <form class="filter form-inline">
<div class="form-group" style="width:100%;">
